...
<html lang="en">
    ...
    <body style="background-image: url('img/theme-4.jpg'); background-repeat: no-repeat; background-size: cover;">
        <ul class="nav justify-content-center" style="text-align: center; color: white; font-family: Papyrus, fantasy">
            ...
            <li class="nav-item">
                <a class="nav-link" href="fillform.php">Upisi se u leksikon</a>
            </li>
            <li class="nav-item">
